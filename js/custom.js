...
(function ($) {
	...
	//  Shop Product Price Range rev_slider function by = bootstrap-slider.min.js ========================== //
	...
	//________ Home carousel  function by = owl.carousel.js________//	
   ...
   ===========================*/
	...
	var menuToggleButton = document.getElementById('mobile-side-drawer');
...
$('.banner-accept').click(function (event) {
...
$(document).ready(function () {
	$('.floor-plan-button').on('click', function (event) {
		event.preventDefault(); // Prevent the default anchor click behavior

		var floorPlanImage = $(this).data('floorplan');
		var floorPlanTitle = $(this).data('title'); // Get the title from the data attribute

		var modalContent = `
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title">${floorPlanTitle}</h5> <!-- Dynamic title -->
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>
		  <div class="modal-body">
			<img src="images/london/${floorPlanImage}/floor-plan.jpg" class="img-responsive" alt="${floorPlanTitle}" />
		  </div>
		</div>
	  `;

		$('#floorPlanModal .modal-dialog').html(modalContent); // Inject the content into the modal
		$('#floorPlanModal').modal('show'); // Open the modal
	});
});

window.onload = function () {
	var boxes = document.querySelectorAll('.testimonials-box');
	var maxHeight = 0;
	// First, find the tallest box
	boxes.forEach(function (box) {
		if (box.offsetHeight > maxHeight) {
			maxHeight = box.offsetHeight;
		}
	});
	// Then, set all boxes to that height
	boxes.forEach(function (box) {
