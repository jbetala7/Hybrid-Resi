    ...
    <div id="rev_slider_346_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.3">
        <ul>
            ...
            <li data-index="rs-964" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/london/battersea/3-bed/1.jpg",
                ...
                <!-- MAIN IMAGE -->
                <img src="images/london/battersea/banner.jpg" data-beforeafter="after" data-bgcolor='' alt=""
                ...
                <div class="tp-caption   tp-resizeme  tp-blackshadow rs-parallaxlevel-5" id="slide-964-layer-4"
                    ...
                    style="z-index: 16; white-space: nowrap; font-size: 120px; line-height: 120px; font-weight: 900; color: #000; letter-spacing: 10px;
                        font-family: 'montserratregular', sans-serif; text-transform: uppercase;">Battersea </div>
            </li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="about-home-3 m-b30 bg-white">
                        <h3 class="m-t0 m-b20 sx-tilte text-center text-uppercase">Hybrid Resi - Battersea</h3>
                    ...
                    <div class="col-12 pic-bg-border">
                        <div class="work-carousel-outer">
                            <div
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/battersea/1-bed/4.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS5 5-->
                                <div class="item">
                    ...
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/battersea/2-bed/2.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 3 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/battersea/2-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/battersea/2-bed/4.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/battersea/2-bed/7.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                    ...
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/battersea/3-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
