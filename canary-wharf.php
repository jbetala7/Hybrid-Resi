...
$description = 'Discover luxury apartments in Canary Wharf with Hybrid Resi. Explore modern, fully furnished residences offering top amenities and stunning views in London’s financial hub.';
include 'header.php' ?>
    ...
    <div id="rev_slider_346_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.3">
        <ul>
            ...
            <li data-index="rs-964" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/london/canary-wharf/1-bed/1.jpg",
                ...
                <!-- MAIN IMAGE -->
                <img src="images/london/canary-wharf/banner.jpg" data-beforeafter="after" data-bgcolor='' alt=""
                ...
                <div class="tp-caption   tp-resizeme  tp-blackshadow rs-parallaxlevel-5" id="slide-964-layer-4"
                    ...
                    style="z-index: 16; white-space: nowrap; font-size: 120px; line-height: 120px; font-weight: 900; color: #000; letter-spacing: 10px;
                        font-family: 'montserratregular', sans-serif; text-transform: uppercase;">Canary Wharf </div>
            </li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="about-home-3 m-b30 bg-white">
                        <h1 class="m-t0 m-b20 sx-tilte text-center text-uppercase">Hybrid Resi - Canary Wharf</h1>
            ...
            <div class="our-history text-black">
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            <div class="large-title">
                                <h2 class="m-t20 text-uppercase">One-Bedroom Apartments</h2>
                            ...
                            <a target="_blank" href="https://my.matterport.com/show/?m=QjTR7N9m5Dq&play=1&hr=1&ts=0"
                            ...
                            <a href="#" class="site-button-secondry btn-half floor-plan-button"
                                ...
                                data-floorplan="canary-wharf/1-bed"><span>Floor Plan</span></a>
                        </div>
                    </div>
                </div>
                <!-- AMENITIES -->
                            ...
                            <div class="ambox m-b50">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                                        <img src="images/icons/guest.png" alt="Icon guest" class="img-center">
                                        <p class="text-center smallp">2 Guests</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                                        <img src="images/icons/storage.png" alt="storage Icon" class="img-center">
                ...
                <div class="row">
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/canary-wharf/2-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/canary-wharf/2-bed/4.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/canary-wharf/2-bed/7.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/canary-wharf/2-bed/8.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 9 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/canary-wharf/2-bed/11.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS5 12-->
                                <div class="item">
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            <div class="large-title">
                                <h2 class="m-t20 text-uppercase">Two-Bedroom Apartments</h2>
                            </div>2
