    ...
    <div id="rev_slider_346_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.3">
        <ul>
            ...
            <li data-index="rs-964" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/dubai/marina/1-bed/12.webp",
                ...
                <!-- MAIN IMAGE -->
                <img src="images/dubai/marina/banner.webp" data-beforeafter="after" data-bgcolor='' alt=""
                ...
                <div class="tp-caption   tp-resizeme  tp-blackshadow rs-parallaxlevel-5" id="slide-964-layer-4"
                    ...
                    style="z-index: 16; white-space: nowrap; font-size: 120px; line-height: 120px; font-weight: 900; color: #000; letter-spacing: 10px;
                        font-family: 'montserratregular', sans-serif; text-transform: uppercase;">Marina </div>
            </li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="about-home-3 m-b30 bg-white">
                        <h3 class="m-t0 m-b20 sx-tilte text-center text-uppercase">Hybrid Resi - Marina</h3>
                        <p align="justify" class="list-angle-right anchor-line text-center">
                            Welcome to the epitome of luxury living at our serviced apartments in Marina Dubai.
                ...
                <div class="row">
                            ...
                            <div
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/1.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/7.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/9.JPG);">
                                    </div>
                                </div>
                                <!-- COLUMNS5 10-->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/10.JPG);">
                                    </div>
                                </div>
                                <!-- COLUMNS 11 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/11.JPG);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/13.webp);">
                                    </div>
                                </div>
                                <!-- COLUMNS 14 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/14.webp);">
                                    </div>
                                </div>
                                <!-- COLUMNS 15 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/15.webp);">
                                    </div>
                                </div>
                                <!-- COLUMNS5 16-->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/16.webp);">
                                    </div>
                                </div>
                                <!-- COLUMNS 17 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/17.webp);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/1-bed/18.webp);">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">Explore our modern one-bedroom units nestled in Marina Dubai, ranging from approximately 57 to 80 sq.
                                m, boasting luxurious floor finishing and accommodating up to 2 people, with select units featuring sofa
                                beds to accommodate up to 2 guests. Each apartment includes 1 parking space. The spacious living rooms
                                are elegantly designed in a contemporary style, while our fully equipped kitchens offer everything you
                                need for cooking, from toasters to coffee machines. Some units offer balconies boasting iconic
                ...
                <div class="row">
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/1.webp);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/5.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/7.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/10.webp);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/11.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 12 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/13.webp);">
                                    </div>
                                </div>
                                <!-- COLUMNS 14 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/14.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/dubai/marina/2-bed/15.jpeg);">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">Indulge in unmatched luxury in our spacious two-bedroom apartments located in Marina
                                Dubai, spanning approximately from 100 to 125 sqm. Guests enjoy complimentary Wi-Fi and
                                access to our 24/7 concierge service, along with complimentary drinks, tea, and coffee,
                                while your valuables remain secure in the provided electronic safe. All guests benefit
                                from complimentary parking and access to building amenities, promising an unforgettable
                                stay in Dubai&#39;s vibrant Marina district. Some units offer balconies boasting iconic views,
