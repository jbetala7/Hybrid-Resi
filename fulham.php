    ...
    <div id="rev_slider_346_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.3">
        <ul>
            ...
            <li data-index="rs-964" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/london/fulham/1-bed/1.jpg",
                ...
                <!-- MAIN IMAGE -->
                <img src="images/london/fulham/banner.jpg" data-beforeafter="after" data-bgcolor='' alt=""
                ...
                <div class="tp-caption   tp-resizeme  tp-blackshadow rs-parallaxlevel-5" id="slide-964-layer-4"
                    ...
                    style="z-index: 16; white-space: nowrap; font-size: 120px; line-height: 120px; font-weight: 900; color: #000; letter-spacing: 10px;
                        font-family: 'montserratregular', sans-serif; text-transform: uppercase;">Fulham </div>
            </li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="about-home-3 m-b30 bg-white">
                        <h3 class="m-t0 m-b20 sx-tilte text-center text-uppercase">Hybrid Resi - Fulham</h3>
                        <p align="justify" class="list-angle-right anchor-line text-center">
                            These contemporary apartments on bustling Fulham Road provide every guest with their perfect
                            home within London City. These Apartments are 4 miles from Buckingham Palace and a 7-minute
                            walk from Putney Bridge tube station or 12 minutes to Parsons Green tube station. Fulham
                            lies on the north bank of the River Thames, bordering Hammersmith, Kensington, and Chelsea
                            in Zone - 2. As a corporate housing, you'll find everything you need for your stay.
                        </p>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="section-content ">
            <div class="our-history text-black">
                <!-- ONE BEDROOM APARTMENT SECTION START -->
                <div class="row">
                    <div class="col-12 pic-bg-border">
                        <div class="work-carousel-outer">
                            <div
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/1-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/1-bed/4.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS5 5-->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/1-bed/6.jpg);">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">Each of our individually designed one-bed apartments in the heart of
                                ...
                                a busy day. Relax in a separate lounge incorporating a fully fitted kitchen, dining
                                area, and living room before you retreat to your bedroom.
                                <br>
                                The apartment boasts a fully fitted kitchen and dining space with beautifully designed
                                bathrooms.<br>
                        ...
                        <div class="col-md-12" data-aos="fade-up" data-aos-duration="800">
                            ...
                            <div class="ambox m-b50">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/storage.png" alt="storage Icon"
                                            class="img-center">
                                        <p class="text-center smallp">Storage Space</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/fridge.png" alt="fridge Icon"
                                            class="img-center">
                                        <p class="text-center smallp">Fridge</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/microwave.png" alt="microwave Icon"
                                            class="img-center">
                                        <p class="text-center smallp">Microwave</p>
                                    </div>

                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img
                                            src="images/icons/double-bed.png" alt="Icon double-bed" class="img-center">
                                        <p class="text-center smallp">Double Size Bed</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/hairdryer.png" alt="hairdryer Icon"
                                            class="img-center">
                                        <p class="text-center smallp">Hair Dryer</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/hob.png" alt="hob Icon"
                                            class="img-center">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img
                                            src="images/icons/washing-machine.png" alt="Hybrid Resi washing-machine Icon" class="img-center">
                                        <p class="text-center smallp">Washing Machine</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img
                                            src="images/icons/work-chair-desk.png" alt="Icon work-chair-desk" class="img-center">
                                        <p class="text-center smallp">Work Desk & Chair</p>
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/kitchen.png" alt="Icon kitchen"
                                            class="img-center">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img
                                            src="images/icons/weekly-cleaning.png" alt="Icon weekly-cleaning" class="img-center">
                    ...
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/2-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/2-bed/4.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/2-bed/5.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/2-bed/7.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/2-bed/8.jpg);">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">Set within traditional red-brick townhouses, just a stone's throw from
                                ...
                                buildings rooted in history. Luxurious space and comfort with a similar design as our
                                other apartments. The apartment boasts a fully fitted kitchen and dining space with
                                beautifully designed bathrooms.
                                <br>
                                These apartments are the perfect home in London, with plenty of room for one to relax
                                and work.<br>
                                <span class="m-t10 badge badge-primary"><img src="images/icons/scale.png" alt="Icon scale"> Area : Approx
                                    105 Sqm</span>
                            </p>
                        ...
                        <div class="col-md-12" data-aos="fade-up" data-aos-duration="800">
                            ...
                            <div class="ambox m-b50">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/king-bed.png" alt="Hybrid Resi king-bed Icon"
                                            class="img-center">
                    ...
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/3-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/3-bed/4.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/3-bed/5.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/3-bed/8.jpg);">
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">The most spacious of our apartments, three-bed apartments are perfect for
                                ...
                                light through the skylight windows, our three beautiful bedrooms come with a Super King
                                (Zip & link), King, and double beds. The apartment boasts a fully fitted kitchen, dining
                                space, and two bathrooms.
                                <br>
                                These apartments are the perfect family home in London, with plenty of room for the
                                whole family to relax and work.<br>
                                <span class="m-t10 badge badge-primary"><img src="images/icons/scale.png" alt="Icon scale"> Area : Approx
                                    115 Sqm</span>
                            </p>
                ...
                <div class="section-content">
                    ...
                    <div class="row">
                        <div class="col-md-12" data-aos="fade-up" data-aos-duration="800">
                            <h3 class="mt-tb20">Amenities in three-bedroom apartments:</h3>
                            <div class="ambox m-b50">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/guest.png" alt="Icon guest"
                                            class="img-center">
                ...
                <!-- DUPLEX THREE BEDROOMS SECTION START -->
                <div class="row">
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/duplex-3-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/duplex-3-bed/4.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/duplex-3-bed/5.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/duplex-3-bed/6.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/fulham/duplex-3-bed/7.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">Set within traditional red-brick townhouses, just a stone's throw from
                                ...
                                from buildings rooted in history. Luxurious space and comfort with a similar design as
                                our other apartments. The apartment boasts a fully fitted kitchen and dining space with
                                beautifully designed bathrooms. These apartments are the perfect home in London, with
                                plenty of room to relax and work.
                                <br>
                                These apartments are the perfect family home in London, with plenty of room for the
                                whole family to relax and work.<br>
                                <span class="m-t10 badge badge-primary"><img src="images/icons/scale.png" alt="Icon scale"> Area : Approx
                ...
                <div class="section-content">
                    ...
                    <div class="row">
                        <div class="col-md-12" data-aos="fade-up" data-aos-duration="800">
                            <h3 class="mt-tb20">Amenities in duplex three-bedroom apartments:</h3>
                            <div class="ambox m-b50">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-6 col-6"> <img src="images/icons/guest.png" alt="Icon guest"
                                            class="img-center">
                ...
                <!-- DUPLEX THREE BEDROOMS SECTION END -->
    ...
    <div class="container">
        <div class="section-content ">
            <iframe class="map-div" frameborder="0" style="border:0" referrerpolicy="no-referrer-when-downgrade"
                loading="async"
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBYgzaO9qjb5n9DnMIyIpmK1eu6uAmF1Lg&q=Hybrid+Resi+Fulham+672+784+Fulham+Rd+London+SW65SJ,UK"
