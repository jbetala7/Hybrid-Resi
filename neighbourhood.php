<?php
$page = 'neighbourhood';
$title = 'Hybrid Resi | Neighbourhoood | Fulham Palace';
include 'header.php' ?>
        ...
        <div class="sx-bnr-inr-entry">
            <!-- <div class="banner-title-outer">
                <div class="banner-title-name">
                    <h2 class="m-tb0">Neighbourhoood</h2>
                </div>
            </div> -->
            <!-- BREADCRUMB ROW -->
                        ...
                        <div class="panel sx-panel">
                            ...
                            <div id="collapseOne5" class="acod-body collapse show">
                                <div class="acod-content p-tb15">
                                    <p align="justify"> Motivate others and change the way we feel about ourselves. This is why I find
                                        them so interesting and crucial on our paths to success mauris accumsan eros
                                        ...
                                        consectetur vel posuere posuere, rutrum eu ipsum. Cost is important.</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel sx-panel">
                            ...
                            <div id="collapseTwo5" class="acod-body collapse">
                                <div class="acod-content p-tb15">Inspirational quotes have an amazing ability to
                                    motivate others and change the way we feel about ourselves. This is why I find them
                                    so interesting and crucial on our paths to success.</div>
                            </div>
                        </div>
                        <div class="panel sx-panel">
                            <div class="acod-head">
                            ...
                            <div id="collapseThree5" class="acod-body collapse">
                                <div class="acod-content p-tb15">The leap into electronic typesetting, remaining
                                    essentially unchanged. It was popularised sheets containing Lorem Ipsum passagese.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 m-b30">
                            <div class="sx-icon-box-wraper p-a30  center bg-white shadow">
                                <div
                                    class="sx-icon-box-lg inline-icon text-primary  m-b20 radius bg-secondry  scale-in-center">
                                    <span class="icon-cell sx-text-primary"><i class="flaticon-door"></i></span>
                                </div>
                                <div class="icon-content">
                                    <h4 class="sx-tilte">Decoration</h4>
                                    <p align="justify">Lorem Ipsum is simply dummy text of the printing and setting as Planning.</p>
                                    <a href="#" class="site-button-link">Read More</a>
                                </div>
                            </div>
                        </div>
