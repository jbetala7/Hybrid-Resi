    ...
    <div id="rev_slider_346_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.3">
        <ul>
            ...
            <li data-index="rs-964" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                data-description=""
                data-beforeafter='{"moveto":"50%|50%|50%|50%","bgColor":"#e7e7e7","bgType":"image","bgImage":"images/london/new-malden/3-bed/2.jpg",
                ...
                <!-- MAIN IMAGE -->
                <img src="images/london/new-malden/banner.jpg" data-beforeafter="after" data-bgcolor='' alt=""
                ...
                <div class="tp-caption   tp-resizeme  tp-blackshadow rs-parallaxlevel-5" id="slide-964-layer-4"
                    ...
                    style="z-index: 16; white-space: nowrap; font-size: 120px; line-height: 120px; font-weight: 900; color: #000; letter-spacing: 10px;
                        font-family: 'montserratregular', sans-serif; text-transform: uppercase;">New Malden </div>
            </li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="about-home-3 m-b30 bg-white">
                        <h3 class="m-t0 m-b20 sx-tilte text-center text-uppercase">Hybrid Resi - New Malden</h3>
                        <p align="justify" class="list-angle-right anchor-line text-center">
                            These contemporary apartments in New Malden, located in the Royal Borough of Kingston upon
                            Thames, provide every guest with their perfect home within Greater London, with a direct
                            30-minute train ride to London Waterloo. The apartments are conveniently situated next to
                            New Malden train station. Positioned in the pleasant suburb of southwest London, New Malden
                            is just under 10 miles from Charing Cross. Richmond Park, with its herd of deer, is a
                            15-minute drive away, just off the A3, giving the area a true countryside feels.
                            Neighbouring localities include Kingston, Norbiton, Raynes Park, Surbiton, Tolworth, and
                            Worcester Park, with Wimbledon only a 10-15-minute drive away.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-12 pic-bg-border">
                        <div class="work-carousel-outer">
                            <div
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/1-bed/3.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/1-bed/5.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">These one-bedroom apartments feature a double-size bed, a hybrid office
                                desk, and an executive chair. Additionally, each unit includes a bathroom, a living area
                                with rooflights, and a fully equipped kitchen with an oven, hob, microwave, fridge
                                freezer, and washing machine. Apartment facilities include a dining area, a smart TV,
                                and free internet access. With access granted to all our guests, they can enjoy sunny
                                days in the communal garden.<br>
                    ...
                    <div class="col-12 pic-bg-border theme-border">
                        <div class="work-carousel-outer">
                            <div class="owl-carousel mfp-gallery home-carousel owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/4.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/5.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/6.jpg);">
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/8.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 9 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/10.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS5 11-->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/12.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 13 -->
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/13.jpg);">
                                    </div>
                                </div>
                                <!-- COLUMNS 14 -->
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="our-history-pic bg-no-repeat bg-center bg-cover"
                                        style="background-image:url(images/london/new-malden/3-bed/15.jpg);">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="our-history-content m-b30">
                            ...
                            <p align="justify">These three-bedroom apartments feature a double-size bed along with two
                                ...
                                hob, microwave, and fridge freezer, as well as access to a communal garden. Apartment
    ...
    <div class="container">
        <div class="section-content ">
            <iframe class="map-div" frameborder="0" style="border:0" referrerpolicy="no-referrer-when-downgrade"
                loading="async"
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBYgzaO9qjb5n9DnMIyIpmK1eu6uAmF1Lg&q=Hybrid+Resi+New+Malden+Dukes+Ave+New+Malden+KT34HN,UK"
...
<script src='https://www.thehotelsnetwork.com/js/loader.js?property_id=1052504&account_key=255B00A554F56568133CAA8CCC2B16CF' async></script>
